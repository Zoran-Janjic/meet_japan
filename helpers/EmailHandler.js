...
module.exports = class EmailHandler {
  ...
  async sendNewAccountConfirmationEmail(user, emailConfirmationToken) {
    ...
    <body>
      <div class="container">
        <h1>Welcome to Meet Japan ${user.name}</h1>
        <p>
          Thank you for joining our community! Let's get you started by confirming your email address on the link below:
          <a href="${emailConfirmationToken}" class="reset-button">Confirm email</a>
        </p>
        <p>
  ...
  async sendNewUserAccountConfirmedEmail(user) {
    const welcomeToMeetJapanHTML = `<!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8">
    ...
    <body>
      <div class="container">
        <h1>Welcome to Meet Japan ${user.name}</h1>
        <p>
          Thank you for confirming your email! We are delighted to have you on board. Get ready to explore, connect, and experience the beauty of our platform. But first, let's get you started by confirming your email address on the link below:
        </p>
        <p>
          Feel free to explore our features and connect with other members. If you have any questions or need assistance, don't hesitate to <a href="mailto:meetjapanhelp@gmail.com">contact our support team</a>.
        </p>
